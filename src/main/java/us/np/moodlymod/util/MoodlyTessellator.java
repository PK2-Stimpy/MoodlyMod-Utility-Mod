...
public class MoodlyTessellator extends Tessellator {
    public static MoodlyTessellator INSTANCE;
    public MoodlyTessellator() {
        super(2097152);
    }
    ...
    public static void begin(final int mode) {
        MoodlyTessellator.INSTANCE.getBuffer().begin(mode, DefaultVertexFormats.POSITION_COLOR);
    }
    ...
    public static void render() {
        MoodlyTessellator.INSTANCE.draw();
    }
    ...
    public static void drawBox(final float x, final float y, final float z, final int argb, final int sides) {
        ...
        final int g = argb >>> 8 & 0xFF;
        final int b = argb & 0xFF;
        drawBox(MoodlyTessellator.INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }

    public static void drawBox(final BlockPos blockPos, final int r, final int g, final int b, final int a, final int sides) {
        drawBox(MoodlyTessellator.INSTANCE.getBuffer(), (float)blockPos.getX(), (float)blockPos.getY(), (float)blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }

    public static BufferBuilder getBufferBuilder() {
        return MoodlyTessellator.INSTANCE.getBuffer();
    }
    ...
    public static void drawFace(final BlockPos blockPos, final int r, final int g, final int b, final int a, final int sides) {
        drawFace(MoodlyTessellator.INSTANCE.getBuffer(), (float)blockPos.getX(), (float)blockPos.getY(), (float)blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void drawFaceOutline(final BlockPos blockPos, final int r, final int g, final int b, final int a, final int sides) {
        drawFaceOutline(MoodlyTessellator.INSTANCE.getBuffer(), (float)blockPos.getX(), (float)blockPos.getY(), (float)blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void drawBoxOutline(final float x, final float y, final float z, final int argb, final int sides) {
        ...
        final int g = argb >>> 8 & 0xFF;
        final int b = argb & 0xFF;
        drawBoxOutline(MoodlyTessellator.INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void drawBoxOutline(final BlockPos blockPos, final int r, final int g, final int b, final int a, final int sides) {
        drawBoxOutline(MoodlyTessellator.INSTANCE.getBuffer(), (float)blockPos.getX(), (float)blockPos.getY(), (float)blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void drawLines(final BlockPos blockPos, final int r, final int g, final int b, final int a, final int sides) {
        drawLines(MoodlyTessellator.INSTANCE.getBuffer(), (float)blockPos.getX(), (float)blockPos.getY(), (float)blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    static {
        MoodlyTessellator.INSTANCE = new MoodlyTessellator();
    }
}